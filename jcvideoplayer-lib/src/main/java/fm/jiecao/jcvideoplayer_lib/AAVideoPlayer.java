 ...
 */
public abstract class AAVideoPlayer extends FrameLayout implements JCMediaPlayerListener, View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener, TextureView.SurfaceTextureListener {
...
//        }
    ...
    private void toWindowFullscreen() {
        ...
        try {
            Constructor<AAVideoPlayer> constructor = (Constructor<AAVideoPlayer>) AAVideoPlayer.this.getClass().getConstructor(Context.class);
            AAVideoPlayer jcVideoPlayer = constructor.newInstance(getContext());
