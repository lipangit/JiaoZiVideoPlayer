...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  Button btnToFullscreen_simple, btnToFullscreen_standard,
    btnToListActivity, btnToListViewPagerActivity, btnToListViewPagerFragmentActivity, btnToImageLoadActivity;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btnToListViewPagerFragmentActivity = (Button) findViewById(R.id.to_list_viewpager_fragment_activity);
    ...
    btnToListViewPagerFragmentActivity.setOnClickListener(this);
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      ...
      case R.id.to_list_viewpager_activity:
        ...
        break;
      case R.id.to_list_viewpager_fragment_activity:
        startActivity(new Intent(MainActivity.this, ListViewPagerFragmentActivity.class));
        break;
